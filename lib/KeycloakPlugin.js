...
var createMemoryStore = __importStar(require("memorystore"));
...
var KeycloakPlugin = /** @class */ (function () {
    function KeycloakPlugin() {
        ...
        this.init = function (ctx) {
            ...
            keycloak.authenticated = function (_req) {
        ...
        this.getRealmName = function (req, realmConfig) {
            ...
            switch (realmConfig.in) {
                ...
                default:
                    logger.warning('Failed to extract realm from request. Reason: invalid realm config.');
                    realm = '';
            }
            return realm;
        };
